...
class EditExercise extends Component {
    ...
    componentDidMount() {
        axios.get(`${this.API_URI}/exercises/${this.props.match.params.id}`)
            .then(response => {
            ...
            .catch(error => console.log(`Error in fetching exercise`));
    ...
    onSubmit(e) {
        ...
        axios.post(`${this.API_URI}/exercises/update/${this.props.match.params.id}`, exercise)
            .then(response => {
                if (response && response.data) {
                    window.location = '/';
                }
            })
            .catch(err => console.log(`Failed to update Exercise ${err}`));
    }

    render() {
        return (
            <div className="mt-20">
                <h3 className="mb-20">Edit Exercise Log</h3>
